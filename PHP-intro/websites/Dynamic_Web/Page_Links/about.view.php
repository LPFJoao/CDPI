...
<body class="h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="rounded-md text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium hover:text-white">Home</a>
              <a href="/about.php" class="rounded-md px-3 py-2 text-sm font-medium  bg-gray-900 text-white">About Us</a>
  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <p>Hello, You are on the about page</p>
    </div>
  </main>
</div>
</body>
